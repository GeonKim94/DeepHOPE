...
%%
feats_test = feats_test(lines_test > 0, :);
types_test = types_test(lines_test > 0, :);
lines_test = lines_test(lines_test > 0, :);
...
[reduction, umap, clusterIdentifiers, extras]=run_umap(feats_test,...
...
type_ = types_test(idxs_thisline(1));
    ...
    plot(reduction(idxs_thisline,1),reduction(idxs_thisline,2), marker_,...
        'MarkerSize',mkrsize_, 'Color', color_)
