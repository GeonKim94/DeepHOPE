...
dir_save = '/data02/gkim/stem_cell_jwshin/data/230306_feature_v3';
cd(dir_source);
dir_set = dir('0*');
...
%                     set(gca, 'Colormap',gray)
    ...
    %                 set(gca, 'Colormap',gray)
                    ...
                    save(strrep(fname, '.TCF',sprintf('_hr%02d.mat',hour)), 'smoothness', 'ncont_bound',...
