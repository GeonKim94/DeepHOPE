...
dir_source = '/data02/gkim/stem_cell_jwshin/data/230502_TCF'; 
dir_save = '/data02/gkim/stem_cell_jwshin/data/230502_MIPH5_wider_v3'; 
dir_img = '/data02/gkim/stem_cell_jwshin/data/230502_MIPPNG_wider_v3';
...
for iter_set = length(dir_set):-1:1
    ...
    for iter_cls = 1:length(dir_cls)%3:3:9%1:length(dir_cls)
...
%             for z_ = z_sample
%                 figure(1),
%                 imagesc(tomo_stitch(:,:,z_), [13300 14000]), axis image, colormap gray
%                 pause()
%             end
...
%             subplot(1,2,2), imagesc(data(:,:,end), [13300 13800]), axis image, colormap gray
            subplot(1,2,1), imagesc(data, [13300 13800]), axis image, colormap gray
