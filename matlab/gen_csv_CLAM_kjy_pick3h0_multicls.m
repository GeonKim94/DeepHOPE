    ...
    for j = 1:numel(subsubdirs)
        ...
        for k = 1:numel(h5Files)
            ...
            elseif strcmp(caseID, '02_ecto_24h')
                label = 'ecto24_psc';
            elseif strcmp(caseID, '02_ecto_48h')
                continue;
                label = 'ecto48_psc';
            elseif strcmp(caseID, '02_ecto_72h')
                continue;
                label = 'ecto72_psc';
            ...
            elseif strcmp(caseID, '03_meso_24h')
                label = 'meso24_psc';
            elseif strcmp(caseID, '03_meso_48h')
                continue;
                label = 'meso48_psc';
            ...
            elseif strcmp(caseID, '04_endo_24h')
                label = 'endo24_psc';
            elseif strcmp(caseID, '04_endo_48h')
                continue;
                label = 'endo48_psc';
            else
                continue;
