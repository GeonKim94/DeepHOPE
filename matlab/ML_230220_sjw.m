...
clear
clc
dir_save = '/data02/gkim/stem_cell_jwshin/data';
cd(dir_save)
mkdir('230220_feature_sjw')
dir_save = '/data02/gkim/stem_cell_jwshin/data/230220_feature_sjw';
...
for iter_set = 1:length(dir_set)
    ...
    for iter_cls = 1:length(dir_cls)
        ...
        for iter_fea = 1:length(dir_fea)
            ...
            if area_col<0.5*10^4 || area_col>2*10^4
                continue
            end
