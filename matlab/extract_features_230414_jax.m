%% extract features for jax cells

dir_source = '/data02/gkim/stem_cell_jwshin/data/230323_TCF';%220822_TCF';
dir_save = '/data02/gkim/stem_cell_jwshin/data/230323_feature_v2';
cd(dir_source);
dir_set = dir('0*');
        ...
        for iter_cls = 1:length(dir_cls)
            ...
            dir_tcf = dir('2*');
                ...
                for iter_tcf = 1:length(dir_tcf)
                    ...
                    tomo_temp = h5read(fname, sprintf('/Data/3D/%06d', 0));%hour
...
dir_source = '/data02/gkim/stem_cell_jwshin/data/230413_TCF';%220822_TCF';
dir_save = '/data02/gkim/stem_cell_jwshin/data/230413_feature_v2';
cd(dir_source);
dir_set = dir('0*');
