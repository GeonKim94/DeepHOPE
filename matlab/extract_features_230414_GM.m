%% extract features for GM cells

dir_source = '/data02/gkim/stem_cell_jwshin/data/230407_TCF';%220822_TCF';
dir_save = '/data02/gkim/stem_cell_jwshin/data/230407_feature_v2';
cd(dir_source);
dir_set = dir('0*');
