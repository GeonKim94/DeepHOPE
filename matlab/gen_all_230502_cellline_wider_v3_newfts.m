...
dir_feat = [strrep(strrep(strrep(dir_source,'/data02','/workspace01'),'_TCF', '_newfeat_wider_v3'),'/data/','/data/23_feat_wider_v3_allh_onRA_new/')];
...
for iter_set = 1%length(dir_set):-1:1
    cd(dir_source)
