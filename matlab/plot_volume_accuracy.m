    ...
    for iter_hour = 1:length(str_hour)% 3 to be done later
        ...
        for iter_inco = 1:length(vols_inco)
            scatter(1+0.05*randn, vols_inco(iter_inco),...
                40,cols_plot{lines_inco(iter_inco)},'o','MarkerFaceColor',cols_plot{lines_inco(iter_inco)},'MarkerFaceAlpha',0.25)%, 'MarkerSize', 10);
        end
        ...
        for iter_corr = 1:length(vols_corr)
            scatter(2+0.05*randn, vols_corr(iter_corr),...
                40,cols_plot{lines_corr(iter_corr)},'o','MarkerFaceColor',cols_plot{lines_corr(iter_corr)},'MarkerFaceAlpha',0.25)%, 'MarkerSize', 10);
        end
