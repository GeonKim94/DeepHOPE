%% extract features for h9 cells

dir_source = '/data02/gkim/stem_cell_jwshin/data/230419_TCF';%220822_TCF';
dir_save = '/data02/gkim/stem_cell_jwshin/data/230419_feature_v3';
cd(dir_source);
dir_set = dir('0*');

hours = [0:4:24, 1:4:24, 2:4:24, 3:4:24];
for hour = hours
