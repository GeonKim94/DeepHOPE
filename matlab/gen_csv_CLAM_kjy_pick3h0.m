...
%%
csvDir= '/data02/gkim/stem_cell_jwshin/src/python/CLAM_gkim/dataset_csv';
dataDir = '/data02/gkim/stem_cell_jwshin/data/23_SEC1H5_wider_v3_allh_onRA_pfeats/h5_files';
...
disp(dataTable);
cd(csvDir);
csvFileName = 'good_psc_vs_bad_psc_pick3h0.csv';
