...
dir_plot = '/data02/gkim/stem_cell_jwshin/data_present/240123_classification_germ2RA';
...
for line_ = unique(lines_test(lines_test>0))'
        ...
        bar(x_,length(idxs_thisline),'LineWidth',2,'FaceColor','none','FaceColor', colors_target(2+add_cidx,:));
        bar(x_,sum(2-y_ == 1),'LineWidth',2,'FaceColor','none','FaceColor', colors_target(1+add_cidx,:));
...
for line_ = unique(lines_test(lines_test>0))'
        ...
        bar(x_,1,'LineWidth',2,'FaceColor','none','FaceColor', colors_target(2+add_cidx,:));
        bar(x_,sum(2-y_ == 1)/length(idxs_thisline),'LineWidth',2,'FaceColor','none','FaceColor', colors_target(1+add_cidx,:));
