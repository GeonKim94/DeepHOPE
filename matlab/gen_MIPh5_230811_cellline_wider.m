...
dir_source = '/data02/gkim/stem_cell_jwshin/data/230811_TCF'; % 220822_TCF';%220715_TCF';
dir_save = '/data02/gkim/stem_cell_jwshin/data/230811_MIPH5_wider'; %220902_3D';%220803_3D';
dir_img = '/data02/gkim/stem_cell_jwshin/data/230811_MIPPNG_wider';%%230221_PNG'; %220902_PNG';%220803_PNG';
...
for iter_set = length(dir_set):-1:1
    ...
    for iter_cls = 1:3%length(dir_cls)%1:length(dir_cls)
