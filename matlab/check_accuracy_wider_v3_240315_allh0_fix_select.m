...
dir_case = '23_SEC1H5_wider_v3_allh0_GM_germline_fishdeep10_b012_in_lr0.001_ens';
dir_out = [dir_out0 '/' ...
    dir_case];
...
for line_ = unique(lines_test(lines_test>0))'
        ...
        for target_ = [13 9 10 11 12 5 6 7 8 0 1 2 3 4]
...
idx_cls_rearrange = [13 9 10 11 12 5 6 7 8 0 1 2 3 4]; 
...
lines_RA = [1 15 16 18 19 20 22 23 24];
...
lines_iPSC = [26 27 28 29 30 31 32 33];
