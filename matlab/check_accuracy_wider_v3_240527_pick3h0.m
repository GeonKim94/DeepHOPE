...
figure(52)
imagesc(conf_all_norm, [0 1]), colormap magma, axis image
...
figure(55)
imagesc(conf_GL_norm, [0 1]), colormap magma, axis image
saveas(gcf,[dir_plot, '/', 'confusion_GL', '.fig']);
...
figure(56)
imagesc(conf_RA_norm, [0 1]), colormap magma, axis image
...
figure(57)
imagesc(conf_iPSC_norm, [0 1]), colormap magma, axis image
...
figure(55)
imagesc(conf_GMGL_norm, [0 1]), colormap magma, axis image
...
figure(55)
imagesc(conf_GMRA_norm, [0 1]), colormap magma, axis image
...
figure(55)
imagesc(conf_H9RA_norm, [0 1]), colormap magma, axis image
...
figure(55)
imagesc(conf_JXRA_norm, [0 1]), colormap magma, axis image
