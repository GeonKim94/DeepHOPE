...
dir_save = '/data02/gkim/stem_cell_jwshin/data/230306_3D'; %220902_3D';%220803_3D';
dir_img = '/data02/gkim/stem_cell_jwshin/data/230306_PNG';%%230221_PNG'; %220902_PNG';%220803_PNG';
...
for iter_set = 1:length(dir_set)
    ...
    for iter_cls = 1:length(dir_cls)%1:length(dir_cls)
        ...
        for iter_stitch = length(dir_mat):-1:1
            ...
            size_new = [512 512 64];
            size_cen = [384 384 64]; % the size that preprocess3d.py will result in
