...
dir_out = [dir_out0 '/' ...
    '23_SEC1H5_wider_v3_6h_GM_germline_fishdeep10_b012_in_lr0.001'];
...
colors_line = [[0 0 0]%'GM untreated',%1
        [0 0.25 0.25]%'GM + endo 6h',%2
        [0 0.5 0.5]%'GM + endo 12h',%3
        [0 0.75 0.75]%'GM + endo 24h',%4
        [0 1 1]%'GM + endo 48h',%5
        [0.25 0 0.25]%'GM + meso 6h',%6
        [0.5 0 0.5]%'GM + meso 12h',%7
        [0.75 0 0.75]%'GM + meso 24h',%8
        [1.0 0.0 1.0]%'GM + meso 48h',%9
        [0.25 0.25 0]%'GM + ecto 6h',%10
        [0.5 0.5 0]%'GM + ecto 12h',%11
        [0.75 0.75 0]%'GM + ecto 24h',%12
        [1. 1. 0]%'GM + ecto 48h',%13
        [1. 1. 0]%'GM + ecto 72h',%13
        [0.5 0 0]%'GM + RA 12h',%14
        [1 0 0]%'GM + RA 24h',%15
        [0 1 0]%% nothing
        [0 0 0]%'H9 untreated',%17
        [0.5 0 0]%'H9 + RA 12h',%18
        [1 0 0]%'H9 + RA 24h',%19
        [0 0 0]%% nothing
        [0 0 0]%'JAX untreated',%21
        [0.5 0 0]%'JAX + RA 12h',%22
        [1.0 0 0]%'JAX + RA 24h',%23
        [0 1 0]%% nothing
        [0 0 0]%'HD 02',%25
        [0 0 0]%'HD 03',%26
        [0 0 0]%'HD 04',%27
...
markers_line = {'o',...%'GM untreated',%1
        'o',...%[0 0.25 0.25]%'GM + endo 6h',%2
        'o',...%[0 0.5 0.5]%'GM + endo 12h',%3
        'o',...%[0 0.75 0.75]%'GM + endo 24h',%4
        'o',...%[0 1 1]%'GM + endo 48h',%5
        'o',...%[0.25 0 0.25]%'GM + meso 6h',%6
        'o',...%[0.5 0 0.5]%'GM + meso 12h',%7
        'o',...%[0.75 0 0.75]%'GM + meso 24h',%8
        'o',...%[1.0 0.0 1.0]%'GM + meso 48h',%9
        'o',...%[0.25 0.25 0]%'GM + ecto 6h',%10
        'o',...%[0.5 0.5 0]%'GM + ecto 12h',%11
        'o',...%[0.75 0.75 0]%'GM + ecto 24h',%12
        'o',...%[1. 1. 0]%'GM + ecto 48h',%13
        'o',...%[1. 1. 0]%'GM + ecto 72h',%13
        'o',...%[0.5 0 0]%'GM + RA 12h',%14
        'o',...%[1 0 0]%'GM + RA 24h',%15
        '*',...%[0 1 0]%% nothing
        's',...%[0 0 0]%'H9 untreated',%17
        's',...%[0.5 0 0]%'H9 + RA 12h',%18
        's',...%[1 0 0]%'H9 + RA 24h',%19
        '*',...%[0 0 0]%% nothing
        'd',...%[0 0 0]%'JAX untreated',%21
        'd',...%[0.5 0 0]%'JAX + RA 12h',%22
        'd',...%[1.0 0 0]%'JAX + RA 24h',%23
        '*',...%[0 1 0]%% nothing
        '^',...%[0 0 0]%'HD 02',%25
        '^',...%[0 0 0]%'HD 03',%26
        '^',...%[0 0 0]%'HD 04',%27
...
%% other condition for better visualization of hour
...
markers_line = {'o',...%'GM untreated',%1
        's',...%[0 0.25 0.25]%'GM + endo 6h',%2
        'd',...%[0 0.5 0.5]%'GM + endo 12h',%3
        '^',...%[0 0.75 0.75]%'GM + endo 24h',%4
        'p',...%[0 1 1]%'GM + endo 48h',%5
        's',...%[0.25 0 0.25]%'GM + meso 6h',%6
        'd',...%[0.5 0 0.5]%'GM + meso 12h',%7
        '^',...%[0.75 0 0.75]%'GM + meso 24h',%8
        'p',...%[1.0 0.0 1.0]%'GM + meso 48h',%9
        's',...%[0.25 0.25 0]%'GM + ecto 6h',%10
        'd',...%[0.5 0.5 0]%'GM + ecto 12h',%11
        '^',...%[0.75 0.75 0]%'GM + ecto 24h',%12
        'p',...%[1. 1. 0]%'GM + ecto 48h',%13
        'p',...%[1. 1. 0]%'GM + ecto 72h',%13
        'd',...%[0.5 0 0]%'GM + RA 12h',%14
        '^',...%[1 0 0]%'GM + RA 24h',%15
        '.',...%[0 1 0]%% nothing
        'o',...%[0 0 0]%'H9 untreated',%17
        'd',...%[0.5 0 0]%'H9 + RA 12h',%18
        '^',...%[1 0 0]%'H9 + RA 24h',%19
        '*',...%[0 0 0]%% nothing
        'o',...%[0 0 0]%'JAX untreated',%21
        'd',...%[0.5 0 0]%'JAX + RA 12h',%22
        '^',...%[1.0 0 0]%'JAX + RA 24h',%23
        '.',...%[0 1 0]%% nothing
        '*',...%[0 0 0]%'HD 02',%25
