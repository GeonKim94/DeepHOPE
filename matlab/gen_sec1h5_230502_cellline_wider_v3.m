...
dir_source = '/data02/gkim/stem_cell_jwshin/data/231206_TCF'; 
dir_save = '/data02/gkim/stem_cell_jwshin/data/231206_SEC1H5_wider_v3'; 
dir_img = '/data02/gkim/stem_cell_jwshin/data/231206_SEC1PNG_wider_v3';
...
%             subplot(1,2,1), imagesc(max(data,[],3), [13300 13800]), axis image, colormap gray
