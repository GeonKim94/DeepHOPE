...
clc
close all
dir_src = ('/data02/gkim/stem_cell_jwshin/data/230502_feature_v3/00_train');
    ...
    for iter_line = 1:length(dir_line)
        ...
        cd(dir_line(iter_line).name)
            ...
            for iter_feat = 1:length(dir_feat)
                ...
                if contains(dir_line(iter_line).name, 'H9_u')
                    cond = 21;
                elseif contains(dir_line(iter_line).name, 'H9_12h')
                    cond = 11; 
                elseif contains(dir_line(iter_line).name, 'H9_24h')
                    cond = 1;
                elseif contains(dir_line(iter_line).name, 'GM25256_u')
                    cond = 22;
                elseif contains(dir_line(iter_line).name, 'GM25256_12h')
                    cond = 12;
                elseif contains(dir_line(iter_line).name, 'GM25256_24h')
                    cond = 2; 
                elseif contains(dir_line(iter_line).name, 'Jax_u')
                    cond = 23;
                elseif contains(dir_line(iter_line).name, 'Jax_12h')
                    cond = 13;
                elseif contains(dir_line(iter_line).name, 'Jax_24h')
                    cond = 3;
                else
...
cd '/data02/gkim/stem_cell_jwshin/data/230502_feature_v3'
for iter_fea = 1:size(features_,2)
    h_ = figure(iter_fea);
