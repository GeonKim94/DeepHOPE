...
from models.layers.fish_residual_2d import _bn_relu_conv, ResBlock, DownRefinementBlock, TransferBlock, UpRefinementBlock
from models.layers.exfuse_layer_2d import GCN
...
class FishTail(nn.Module):
    ...
    """
    def __init__(self, in_c, out_c, num_blk, norm=nn.BatchNorm2d, act=lambda : nn.ReLU(True)):
        super().__init__()
...
class FishBody(nn.Module):
    ...
    def __init__(self, in_c, out_c, num_blk,
                 ...
                 dilation=1, norm=nn.BatchNorm2d, act=lambda : nn.ReLU(True)):
        super().__init__()
